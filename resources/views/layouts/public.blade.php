                    ...
                    <nav class="flex justify-between items-center">
                        <div class="flex w-fit items-center">
                            ...
                            <a class="" href="{{ url('/') }}">
                                <div class="w-full h-full px-4">
                                    <img class="w-full h-[60px] logo rounded" src="{{ asset('images/logo.png') }}"
                                        alt="brc logo">
                                </div>
                            </a>
                        </div>
                        ...
                        <div style="box-shadow: rgba(67, 71, 85, 0.27) 1px 0px 2px;" id="sidebar2"
                            ...
                            <div
                                ...
                                <a href="{{ url('/') }}" class="flex w-full">
                                    <div class="min-w-[150px] max-w-[190px]">
                                        {{-- <img class="w-[200px] h-[60px] rounded"
                                        src="{{ asset('images/layout/logo.png') }}" alt="Fisheries Logo"> --}}
                                        <p
                                            class="text-center font-[900] text-2xl m-auto dark:text-slate-300 tracking-widest uppercase">
                                            Fisheries
                                        </p>
                                    </div>
                                </a>
                            ...
                            <ul class="flex flex-col lg:flex-row gap-2 lg:gap-6 xl:gap-8 px-4 pt-3 lg:p-0">
                                ...
                                <li>
                                    <a href="{{ url('/') }}"
                                        class="{{ request()->is('/') ? 'bg-gray-100 dark:bg-[#16454e]' : '' }} w-full flex gap-2 items-center py-2 px-3 text-base sm:text-lg no-underline transition-all duration-300 ease-in-out hover:bg-[#0d6a7c] hover:text-white lg:hover:text-black lg:bg-transparent lg:hover:bg-transparent ">
                                ...
                                <li>
                                    <a href="{{ url('/services') }}"
                                        class="{{ request()->is('settings') ? 'bg-gray-100 dark:bg-[#16454e]' : '' }} w-full flex gap-2 items-center py-2 px-3 text-base sm:text-lg no-underline transition-all duration-300 ease-in-out hover:bg-[#0d6a7c] hover:text-white lg:hover:text-black lg:bg-transparent lg:hover:bg-transparent ">
                                        <div class="w-[40px] h-[40px] rounded-md grid place-items-center lg:hidden">
